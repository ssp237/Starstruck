...
public class Spinner extends ComplexObstacle {
	...
	public Spinner(float x, float y, float width, float height) {
		...
		center = new WheelObstacle(x, y, SPIN_PIN_RADIUS);
		center.setName(SPIN_PIN_NAME);
		center.setDensity(LIGHT_DENSITY);
		center.setBodyType(BodyDef.BodyType.StaticBody);
		bodies.add(center);

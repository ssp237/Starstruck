...
import edu.cornell.gdiac.starstruck.WorldController;
 ...
 * loading screen.
 */
public class MenuMode3 extends WorldController implements Screen, InputProcessor, ControllerListener {
     ...
     */
    public MenuMode3(GameCanvas canvas) {
        this.canvas  = canvas;
    ...
    public void loadContent(AssetManager manager) {
        ...
        TextureRegion playButton = JsonAssetManager.getInstance().getEntry("play", TextureRegion.class);
        TextureRegion levelsButton = JsonAssetManager.getInstance().getEntry("levelselect", TextureRegion.class);

        TextureRegion settingsButton = JsonAssetManager.getInstance().getEntry("settings", TextureRegion.class);
        TextureRegion quitButton = JsonAssetManager.getInstance().getEntry("quit", TextureRegion.class);
        TextureRegion helpButton = JsonAssetManager.getInstance().getEntry("help", TextureRegion.class);

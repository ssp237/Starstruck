...
public class TalkingBoss extends Enemy {
     ...
     */
    public TalkingBoss(float x, float y, float width, float height) {
     ...
     */
    public TalkingBoss(float x, float y, FilmStrip texture, Vector2 scale) {
...
//        }
    ...
    public ObstacleType getType() { return ObstacleType.BOSS;}
